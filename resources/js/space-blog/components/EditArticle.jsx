            ...
            <main className="container-xxl d-flex flex-column justify-content-center my-5">
                ...
                <form encType="multipart/form-data" className={"form-content pt-5"}>
                    ...
                    <div className="form-input">
                        ...
                        <textarea className={`form-control ${invalidFields.includes('description') ? 'invalid-input' : ''}`}
                    ...
                    <div className="form-input">
                        ...
                        <textarea className={`form-control ${invalidFields.includes('article_content') ? 'invalid-input' : ''}`}
